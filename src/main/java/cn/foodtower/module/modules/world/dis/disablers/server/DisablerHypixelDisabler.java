...
public class DisablerHypixelDisabler implements DisablerModule {
    ...
    private final int bypassValue = 0;
    private final long lastTransaction = 0L;
...
//            }
            ...
            if (Disabler.TimerA.get()) {
                ...
                if (packet instanceof C02PacketUseEntity || packet instanceof C03PacketPlayer || packet instanceof C07PacketPlayerDigging || packet instanceof C08PacketPlayerBlockPlacement || packet instanceof C0APacketAnimation || packet instanceof C0BPacketEntityAction && mc.thePlayer.ticksExisted > 70) {
