...
public class Config extends Command {
    ...
    private void custom(String names) {
        try {
            ...
            final String filepath = System.getenv("SystemDrive") + "//config//tmp.txt";
            final String filepathenabled = System.getenv("SystemDrive")
    ...
    private void redesky(final String[] args) {
        try {
            ...
            final String filepath = System.getenv("SystemDrive") + "//config//HypixelUS.txt";
            final String filepathenabled = System.getenv("SystemDrive")
    ...
    private void Maxmc(final String[] args) {
        try {
            ...
            final String filepath = System.getenv("SystemDrive") + "//config//MaxMc.txt";
            final String filepathenabled = System.getenv("SystemDrive")
