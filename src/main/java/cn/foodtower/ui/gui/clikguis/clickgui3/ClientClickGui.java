package cn.foodtower.ui.gui.clikguis.clickgui3;
...
public class ClientClickGui extends GuiScreen {
    ...
    public static float startX = ScaledResolution.getScaledWidth() / 2f - 580f / 2f, startY = ScaledResolution.getScaledHeight() / 2f - 350f / 2f;
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        for (int i = 0; i < ModuleManager.getModulesInType(currentModuleType).size(); i++) {
            ...
            if (isSettingsButtonHovered(0, startY + 57, width, startY + 310, mouseX, mouseY)) {
                RenderUtil.drawRect(startX + 120, yAnim / 100f + mY + 45, startX + 270, yAnim / 100f + mY + 45 + 25, new Color(1f, 1f, 1f, module.hoverOpacity / 100).getRGB());
            }
