package cn.foodtower.ui.gui.clikguis.clickgui4;
...
public class ClickGui extends GuiScreen implements GuiYesNoCallback {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        LogoFont.drawCenteredString(Client.name, startX + 10, startY + 10, new Color(255, 255, 255, (int) opacity.getOpacity()).getRGB());
        FontLoaders.GoogleSans18.drawString(Client.version, startX + 35, startY + 25, new Color(200, 200, 200, (int) opacity.getOpacity()).getRGB());
        ...
        if (currentModule != null) {
            ...
            for (int i = 0; i < ModuleManager.getModulesInType(currentModuleType).size(); i++) {
                ...
                if (isSettingsButtonHovered(startX + 90, mY,
                        ...
                        mY + 8 + FontLoaders.GoogleSans20.getStringHeight(""), mouseX, mouseY) && Mouse.isButtonDown(1)) {
            ...
            for (int i = 0; i < currentModule.getValues().size(); i++) {
                ...
                if (value instanceof Mode) {
                    x = startX + 190.0f;
                    Client.FontLoaders.GoogleSans16.drawString(value.getName(), startX + 185.0f, mY - 1.0f + 2, new Color(136, 136, 136).getRGB());
                    RenderUtil.drawRoundedRect(x - 10.0f, mY + 6.0f, x + 75.0f, mY + 22.0f, 3, new Color(86, 154, 255, (int) this.opacity.getOpacity()).getRGB());
                    Client.FontLoaders.GoogleSans18.drawString(((Mode) value).getModeAsString(), x + 30.0f - (float) (font.getStringWidth(((Mode) value).getModeAsString()) / 2), mY + 10.0f + 2, -1);
