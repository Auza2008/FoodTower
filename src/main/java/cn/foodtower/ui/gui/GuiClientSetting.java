...
public class GuiClientSetting extends GuiScreen {
    ...
    public static float startX = ScaledResolution.getScaledWidth() / 2f - 450 / 2f, startY = ScaledResolution.getScaledHeight() / 2f - 350 / 2f;
        ...
        for (int i = 0; i < currentModule.getValues().size(); i++) {
            ...
            if (value instanceof Mode) {
                ...
                font.drawCenteredStringWithShadow(((Mode) value).getModeAsString(),
                        x, mY + 53 + 1, new Color(255, 255, 255).getRGB());
