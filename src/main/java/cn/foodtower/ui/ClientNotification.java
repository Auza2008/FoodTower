...
public class ClientNotification {
    ...
    public ClientNotification(final String message, final Type type) {
        ...
        this.color = HUD.logomode.getValue().equals(HUD.logomodeE.Dark_Distance) || HUD.logomode.getValue().equals(HUD.logomodeE.FoodTower) ? new Color(15, 15, 15).getRGB() : new Color(234, 234, 234).getRGB();
    ...
    public void draw(final double getY, final double lastY) {
        ...
        font.drawCenteredString(this.message, (float) (x1 + this.width / 2.0) - 4.0f, (float) (y1 + this.height / 2f) - 2.5f, HUD.logomode.getValue().equals(HUD.logomodeE.Dark_Distance) || HUD.logomode.getValue().equals(HUD.logomodeE.FoodTower) ? new Color(255, 255, 255).getRGB() : new Color(60, 60, 60).getRGB());
