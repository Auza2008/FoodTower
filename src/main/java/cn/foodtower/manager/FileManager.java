...
import cn.foodtower.ui.login.Alt;
...
public class FileManager {
	...
	static {
		FileManager.dir = new File(Minecraft.getMinecraft().mcDataDir, "FoodTower");
		FileManager.userDir = new File(Minecraft.getMinecraft().mcDataDir, "FoodTowerUserData");
