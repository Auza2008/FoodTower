...
import cn.foodtower.util.render.gl.ScaleUtils;
...
//        GL11.glEnable(GL_MULTISAMPLE);
    ...
    public static void renderTHUD(EntityPlayer e) {
        ...
        mc.fontRendererObj.drawString(text, i2 + 40 + 50 * space - mc.fontRendererObj.getStringWidth(text) / 2, i1 + 18f, 0xffffffff, true);
    ...
    public static void Gamesense(double x, double y, double x1, double y1, double size, float color2, float color3, int badd) {
        ...
        RenderUtil.rectangleBordered(x + 1.0f, y + 1.0f, (x1 + size - 1.0f), y1 + size - 1.0f, 1.0, Colors2.getColor(90 + badd), Colors2.getColor(61));
        RenderUtil.rectangleBordered(x + 2.5, y + 2.5, (x1 + size) - 2.5, (y1 + size) - 2.5, 0.5, Colors2.getColor(61 + badd), Colors2.getColor(0));
    ...
    public static void drawRect2(float x, float y, float x1, float y1, int color) {
