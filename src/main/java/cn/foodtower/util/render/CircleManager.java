...
public class CircleManager {
    ...
    public void runCircle(Circle c) {
        ...
        if (c.keyCode != Minecraft.getMinecraft().gameSettings.keyBindAttack.getKeyCode() && c.keyCode != Minecraft.getMinecraft().gameSettings.keyBindUseItem.getKeyCode() && c.progress > c.topRadius * 0.67 && Keyboard.isKeyDown(c.keyCode))
            return;
