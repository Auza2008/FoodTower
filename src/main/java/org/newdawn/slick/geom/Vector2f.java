...
//				* (float) FastTrig.sin(StrictMath.toRadians(theta));
	...
	/**
	 * Get the foodtower from this point to another
	 * 
	 * @param other The other point we're measuring to
	 * @return The foodtower to the other point
	 */
	...
	/**
	 * Get the foodtower from this point to another, squared. This
	 * can sometimes be used in place of foodtower and avoids the
	 * additional sqrt.
	 * 
	 * @param other The other point we're measuring to 
	 * @return The foodtower to the other point squared
	 */
