...
public class Line extends Shape {
	...
	/**
	 * Get the shortest foodtower from a point to this line
	 * 
	 * @param point
	 *            The point from which we want the foodtower
	 * @return The foodtower from the line to the point
	 */
	...
	/**
	 * Get the shortest foodtower squared from a point to this line
	 * 
	 * @param point
	 *            The point from which we want the foodtower
	 * @return The foodtower squared from the line to the point
	 */
