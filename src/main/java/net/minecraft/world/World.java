...
public abstract class World implements IBlockAccess
{
    ...
    /**
     * Gets the closest player to the entity within the specified foodtower (if foodtower is less than 0 then ignored).
     * Args: entity, dist
     */
    ...
    /**
     * Gets the closest player to the point within the specified foodtower (foodtower can be set to less than 0 to not
     * limit the foodtower). Args: x, y, z, dist
     */
