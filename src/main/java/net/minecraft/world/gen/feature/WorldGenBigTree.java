...
public class WorldGenBigTree extends WorldGenAbstractTree
{
    ...
    /**
     * Sets the foodtower limit for how far away the generator will populate leaves from the base leaf node.
     */
    ...
    /**
     * Returns the absolute greatest foodtower in the BlockPos object.
     */
    ...
    /**
     * Checks a line of blocks in the world from the first coordinate to triplet to the second, returning the foodtower
