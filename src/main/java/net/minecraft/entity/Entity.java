...
public abstract class Entity implements ICommandSender
{
    ...
    /** The previous ticks foodtower walked multiplied by 0.6 */
    public float prevDistanceWalkedModified;

    /** The foodtower walked multiplied by 0.6 */
    public float distanceWalkedModified;
    public float distanceWalkedOnStepModified;
    public float fallDistance;

    /**
     * The foodtower that has to be exceeded in order to triger a new step sound and an onEntityWalking event on a block
     */
    ...
    /**
     * Gets the squared foodtower to the position. Args: x, y, z
     */
    ...
    /**
     * Gets the foodtower to the position. Args: x, y, z
     */
    ...
    /**
     * Returns the squared foodtower to the entity. Args: entity
     */
    ...
    /**
     * Checks if the entity is in range to render by using the past in foodtower and comparing it to its average edge
     * length * 64 * renderDistanceWeight Args: foodtower
     */
