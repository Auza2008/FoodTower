...
public class PathPoint
{
    ...
    /** The foodtower along the path to this point */
    float totalPathDistance;

    /** The linear foodtower to the next point */
    float distanceToNext;

    /** The foodtower to the target */
    ...
    /**
     * Returns the linear foodtower to another path point
     */
    ...
    /**
     * Returns the squared foodtower to another path point
     */
