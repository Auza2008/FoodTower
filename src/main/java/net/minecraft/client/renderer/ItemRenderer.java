...
import cn.foodtower.module.modules.render.Animations;
...
public class ItemRenderer {
    ...
    public void renderItemInFirstPerson(float partialTicks) {
        ...
        float af = 1.0F - (this.prevEquippedProgress + (this.equippedProgress - this.prevEquippedProgress) * partialTicks);
        EntityPlayerSP aentityplayersp = mc.thePlayer;
        float af1 = aentityplayersp.getSwingProgress(partialTicks);
        float af2 = aentityplayersp.prevRotationPitch + (aentityplayersp.rotationPitch - aentityplayersp.prevRotationPitch) * partialTicks;
        float af3 = aentityplayersp.prevRotationYaw + (aentityplayersp.rotationYaw - aentityplayersp.prevRotationYaw) * partialTicks;
