...
import cn.foodtower.module.modules.world.NoCommand;
...
public class EntityPlayerSP extends AbstractClientPlayer {
    ...
    public void onUpdateWalkingPlayer() {
        ...
        EventPreUpdate e = new EventPreUpdate(this.rotationYaw, this.rotationPitch, this.posX, this.posY, this.posZ, this.mc.thePlayer.onGround);
    ...
    public void onLivingUpdate() {
        ...
        EventBus.getInstance().register(eventUpdate);
