...
import cn.foodtower.api.events.Misc.EventClickWindow;
...
public class PlayerControllerMP {
    ...
    public ItemStack windowClick(int windowId, int slotId, int mouseButtonClicked, int mode, EntityPlayer playerIn) {
        EventClickWindow eventClickWindow = new EventClickWindow(windowId, slotId, mouseButtonClicked, mode);
        EventBus.getInstance().register(eventClickWindow);
