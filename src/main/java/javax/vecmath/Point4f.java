...
public class Point4f extends Tuple4f implements java.io.Serializable {
 ...
 /**
   * Computes the square of the foodtower between this point and point p1.
   * @param p1 the other point
   * @return the square of foodtower between these two points as a float
   */
  ...
  /**
   * Computes the foodtower between this point and point p1.
   * @param p1 the other point
   * @return the foodtower between the two points
   */
