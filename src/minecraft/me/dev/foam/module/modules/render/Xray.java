...
public class Xray
        extends Module {
    public static final Numbers<Double> alpha = new Numbers<>("Alpha", "1", 150.0,0.0,255.0,1.0);
    public static final LinkedList<Integer> antiXRayBlocks = new LinkedList<>();
    private static final Numbers<Double> range = new Numbers<>("Range", "1", 50.0,0.0,500.0,1.0);
    private static final Numbers<Double> extremeRange = new Numbers<>("extremeRange", "1", 4.0,0.0,6.0,1.0);
    public static Option<Boolean> coal = new Option<>("Coal", "e", true);
    public static Option<Boolean> iron = new Option<>("iron", "e", true);
    public static Option<Boolean> gold = new Option<>("gold", "e", true);
    public static Option<Boolean> lapisLazuli = new Option<>("lapisLazuli", "e", true);
    public static Option<Boolean> diamond = new Option<>("diamond", "e", true);
    public static Option<Boolean> redStone = new Option<>("redStone", "e", true);
    public static Option<Boolean> emerald = new Option<>("emerald", "e", false);
    public static Option<Boolean> quartz = new Option<>("quartz", "e", false);
    public static Option<Boolean> water = new Option<>("water", "e", false);
    public static Option<Boolean> lava = new Option<>("lava", "e", false);
    public static Option<Boolean> tracer = new Option<>("tracer", "e", false);
    public static Option<Boolean> block = new Option<>("block", "e", false);
    public static Option<Boolean> cave = new Option<>("cave", "e", true);
    public static Option<Boolean> esp = new Option<>("esp", "e", true);
    public static Option<Boolean> extreme = new Option<>("extreme", "e", true);
