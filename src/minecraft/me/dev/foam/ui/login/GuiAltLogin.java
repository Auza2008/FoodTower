...
public class GuiAltLogin
    ...
    public void drawScreen(int x, int y, float z) {
        ...
        FontManager.F18.drawCenteredString("Alt Login", this.width / 2, 20, -1);
        FontManager.F18.drawCenteredString(this.thread == null ? "\u00a7eWaiting..." : this.thread.getStatus(), this.width / 2, 29, -1);
        if (this.username.getText().isEmpty()) {
            FontManager.F18.drawStringWithShadow("Username / E-Mail", this.width / 2 - 96, 66.0f, -7829368);
        }
