...
Project:foam Reborn
*/
package me.dev.foam.ui.hudeditor;
    ...
    public void render(final int mouseX, final int mouseY) {
        if (!this.custom) {
            ...
            if (this.value instanceof Option) {
                ...
                if (mouseX > this.x - 7 && mouseX < this.x + 85 && mouseY > this.y - 6
                        && mouseY < this.y + FontManager.F18.getStringHeight(this.value.getDisplayName()) + 5 && Mouse.isButtonDown(0)) {
            ...
            FontManager.F18.drawString(this.value.getDisplayName(), this.x - 5, this.y + 1, new Color(184, 184, 184).getRGB());// ����
            FontManager.F18.drawString(this.name, this.x + 76 - FontManager.F18.getStringWidth(this.name), this.y + 2,
            ...
            if (this.value instanceof Numbers) {
                ...
                Gui.drawRect(this.x, this.y + FontManager.F18.getStringHeight(this.value.getDisplayName()) + 3,
                        (float) (this.x + render + 1), this.y + FontManager.F18.getStringHeight(this.value.getDisplayName()) + 4,
