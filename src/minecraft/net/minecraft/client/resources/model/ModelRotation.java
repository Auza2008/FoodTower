...
public enum ModelRotation implements IModelState, ITransformation
{
    ...
    public net.optifine.Matrix4f getMatrix()
    {
        return Reflector.ForgeHooksClient_getMatrix.exists() ? (net.optifine.Matrix4f)Reflector.call(Reflector.ForgeHooksClient_getMatrix, new Object[] {this}): new net.optifine.Matrix4f(this.getMatrix4d());
    }
