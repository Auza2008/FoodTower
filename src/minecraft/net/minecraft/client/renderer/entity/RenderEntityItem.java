...
import me.dev.foodtower.module.modules.render.ItemPhysic;
import me.dev.foodtower.utils.client.Physic;
...
public class RenderEntityItem extends Render<EntityItem>
{
    ...
    public void doRender(EntityItem entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        ...
        if (Client.instance.getModuleManager().getModuleByClass(ItemPhysic.class).isEnabled()) {
            Physic.doRenderItemPhysic(entity, x, y, z, entityYaw, partialTicks);
            return;
        }
