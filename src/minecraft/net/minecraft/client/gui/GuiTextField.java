    ...
    public void drawTextBox() {
        if (this.getVisible()) {
            if (this.getEnableBackgroundDrawing()) {
                RenderUtil.drawBordered(this.xPosition, this.yPosition, this.width, this.height, isFocused ? 0.1 : 0, new Color(23, 23, 23).getRGB(), new Color(23, 132, 246).getRGB());
            }
            ...
            if (s.length() > 0) {
                ...
                Minecraft.getMinecraft().fontRendererObj.drawString(s1, l, i1, i);
            ...
            if (s.length() > 0 && flag && j < s.length()) {
                Minecraft.getMinecraft().fontRendererObj.drawString(s.substring(j), j1, i1, i);
            }

            if (flag1) {
                if (flag2) {
                    Gui.drawRect(k1, i1 - 1, k1 + 1, i1 + 1 + Minecraft.getMinecraft().fontRendererObj.FONT_HEIGHT, -3092272);
                } else {
                    Minecraft.getMinecraft().fontRendererObj.drawString("_", k1, i1, i);
                }
            }

            if (k != j) {
                int l1 = l + this.fontRendererInstance.getStringWidth(s.substring(0, k));
                this.drawCursorVertical(k1, i1 - 1, l1 - 1, i1 + 1 + Minecraft.getMinecraft().fontRendererObj.FONT_HEIGHT);
            }
        }
    }
